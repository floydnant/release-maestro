...
On Windows, CI also runs `make test-tools-windows` to check workflow claims for orphaned descendants
and literal argument passing through the Windows launcher.

...
- File-read calls against any `SKILL.md` (project-level, user-level, or plugin-installed — wherever this harness keeps skills)
- Sub-agent or delegation prompts that name a skill path
